...
public class DataSetFiles
{
    ...
    public static final String KddcupTrainingDatasetForBinaryArff = Finals.DATASET_FILES + "SavedArff/" + _TrainDatasetName+ "-4898431.arff";
    public static final String KddcupTestDatasetForBinaryArff = Finals.DATASET_FILES + "SavedArff/"+ _TestDatasetName +"-311029.arff";
